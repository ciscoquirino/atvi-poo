...
public class Cliente{
	...
	private List<ProdutoOuServico> prodservConsumidos;
	public Cliente(String nome, String nomeSocial, CPF cpf, String genero) {
		...
		this.genero = genero;
		this.prodservConsumidos = new ArrayList<>();
	}
	...
	public List<ProdutoOuServico> getProdservConsumidos() {
		return prodservConsumidos;
	}
	...
	public void setProdservConsumidos(List<ProdutoOuServico> prodservConsumidos) {
		this.prodservConsumidos = prodservConsumidos;
	}
	...
	public void alterarGenero() {
		...
		System.out.println("Gênero do cliente alterado. Seja respeitoso");
		System.out.println("--------------------------------------------");
	}
	public void incluirNovoTel() {
		...
		System.out.println("Novo telefone cadastrado com sucesso!");
		System.out.println("--------------------------------------------");
	}
	public void venda(ProdutoOuServico produto) {
		getProdservConsumidos().add(produto);
	}
	public double valorConsumo() {
		double total = 0;
		for (ProdutoOuServico prodserv : prodservConsumidos) {
			total = total + prodserv.valorunit;
		}
		return total;
	}
}